...
var _sticky = __webpack_require__(331);

var _sticky2 = _interopRequireDefault(_sticky);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var zanim = function zanim(type, selector, direction, timing, easing) {
    // var fps = 60,
    //     interval = Math.ceil(1000/fps)
    switch (type) {

        case 'sticky':
            return new _sticky2.default();
            break;
...
var sticky = function () {
  function sticky(options) {
    ...
    this.directionClassIn = 'sticky' + this.capitalize(this.direction) + '_in';
    this.directionClassOut = 'sticky' + this.capitalize(this.direction) + '_out';
  ...
  _createClass(sticky, [{
    ...
    value: function getProps() {
      var props = {
        ...
        '--stickyInKeyframe': this.keyframeIn + this.capitalize(this.direction),
        '--stickyOutKeyframe': this.keyframeOut + this.capitalize(this.direction),
    ...
    value: function setProps(element) {
      ...
      Object.entries(this.getProps()).forEach(function (_ref) {
    ...
    key: 'zanimate',
    value: function zanimate() {
      var _this = this,
          element = document.getElementById(this.selector);

      var zanIn = function zanIn(time) {
        setTimeout(function () {
      ...
      var zanOut = function zanOut(time) {
        setTimeout(function () {
          var element = document.getElementById(_this.selector);
      ...
      var zanStatic = function zanStatic(time) {
        setTimeout(function () {
          var element = document.getElementById(_this.selector);
      ...
      var getAddon = function getAddon(name, time) {
        switch (name) {
          case 'dash':
            var _element = document.getElementById(_this.selector),
                logo = document.getElementById('logo'),
                menu = document.getElementById('menu');
            // show menu and logo after the sticky animation
            _element.addEventListener("animationend", function () {
              addClasses('stickyDash_logo', logo);
              addClasses('stickyDash_menu', menu);
              showElements('sticky_show', logo, menu);
              removeClasses('sticky_hide', logo, menu);
            }, { once: true });
            // hide menu and logo
            //hideElements('sticky_hide', logo, menu)
            zanIn(0);
            break;
        }
      };

      _this.window.addEventListener('scroll', (0, _lodash.throttle)(function () {
        _this.window.requestAnimationFrame(function () {
          // Window Offsets
          if (_this.window.pageYOffset > 0) {
          ...
          } else if (_this.window.pageYOffset === 100) {
            // Animation arrays based on addons
            switch (_this.addon) {
              case 'dash':
                zanOut(10);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(64), __webpack_require__(333)(module)))
...
function removeMultiClass($element) {
...
function hideElements(hideClass) {
